  ...
  return (
    ...
    >
      <div
        ...
        className="group/card rounded-3xl w-full relative overflow-hidden bg-primary/90 flex h-full flex-col">
        <CardPattern mouseX={mouseX} mouseY={mouseY} randomString={randomString} />
        {imageUrl ? (
          <div className="relative z-10 flex h-full w-full flex-col p-3">
            <div className="relative flex-1 overflow-hidden rounded-2xl bg-secondary/10">
              <img
                src={imageUrl}
